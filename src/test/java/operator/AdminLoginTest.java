...
public class AdminLoginTest extends base {
	...
	public void ValidateSuccessfulAdminLogin(HashMap<String, String> data) throws InterruptedException {
		...
		admin.ValidateSuccessfulAdminLogin1(driver, data);
		soft.assertEquals(al.getPromptMessage().getText(), "Success\n"
				+ "Login successfully!");
		db = new DashBoard(driver);
		soft.assertEquals(db.getDashBoardHeader().getText(), "Ecosystem");
		soft.assertAll();
	}
	...
	public  Object[][] getData() {
		...
		Map<String, String> validData = Map.of("emailAddress", "jerryosobase4+002@gmail.com", "otp", "9876543", "agentNoCoupon", "jtest@gmail.com", 
				"lga", "Amuwo-Odofin LGA", "permitName", "test", "companyEmail", "kahiper689@moenode.com",
		...
		Map<String, String> validData1 = Map.of("emailAddress", "jerryosobase4+002@gmail.com", "otp", "9876543", "agentNoCoupon", "jtest@gmail.com", 
				"lga", "Yaba LCDA", "permitName", "online", "companyEmail", "kahiper689@moenode.co", 
	...
	public void ValidateSuccessfulAdminLogin1(WebDriver driver, HashMap<String, String> data){
		...
		al.getEmailAddressField().sendKeys(Keys.chord(Keys.COMMAND, "a"), data.get("emailAddress"));
		al.getContinueButton().click();
		al.getOtpField().sendKeys(Keys.chord(Keys.COMMAND, "a"), data.get("otp"));
